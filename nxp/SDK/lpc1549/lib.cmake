...
function(sdk_mcu_finish)
    # pyocd pack install lpc1549jbd48
    add_custom_target(flash  pyocd load ${PROJECT_NAME}.elf -f 4MHz -t lpc1549jbd48 DEPENDS ${PROJECT_NAME})
    add_custom_target(server pyocd gdbserver --persist -f 4MHz -t lpc1549jbd48 DEPENDS ${PROJECT_NAME})
    add_custom_target(gdb    arm-none-eabi-gdb ${PROJECT_NAME}.elf -ex "tar ext localhost:3333" -ex "load"
        -ex "mon reset halt" -ex "set mem inaccessible-by-default off" DEPENDS disasm)
