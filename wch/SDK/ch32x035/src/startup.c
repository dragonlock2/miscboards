...
void (*vectors[])(void) __attribute__((used)) = {
    ...
    default_handler, // TIM2_UP_IRQn
    default_handler, // USART2_IRQ
    default_handler, // EXTI15_8_IRQn
    default_handler, // EXTI25_16_IRQn
    default_handler, // USART3_IRQn
    default_handler, // USART4_IRQn
    default_handler, // DMA1_Channel8_IRQn
    default_handler, // USBFS_IRQn
    default_handler, // USBFSWakeUp_IRQn
    default_handler, // PIOC_IRQn
    default_handler, // OPA_IRQn
    default_handler, // USBPD_IRQn
    default_handler, // USBPDWakeUp_IRQn
    default_handler, // TIM2_CC_IRQn
    default_handler, // TIM2_TRG_COM_IRQn
    default_handler, // TIM2_BRK_IRQn
