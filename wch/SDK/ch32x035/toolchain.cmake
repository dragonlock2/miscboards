...
set(WCH_SDK_DIR   ${CMAKE_CURRENT_LIST_DIR}/ch32x035/EVT/EXAM/SRC)
...
if (NOT TARGET flash)
    ...
    add_custom_target(gdb    gdb ${PROJECT_NAME}.elf -ex "tar ext localhost:3333" -ex "load" DEPENDS ${PROJECT_NAME}.txt)
endif()
