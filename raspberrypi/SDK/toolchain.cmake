...
function(pico_finalize)
    ...
    add_custom_target(flash_dbg openocd -f interface/cmsis-dap.cfg -f target/${OPENOCD_TARGET} -c "adapter speed 5000"
        -c "program ${PROJECT_NAME}.elf verify reset exit" DEPENDS ${PROJECT_NAME})
    add_custom_target(server openocd -f interface/cmsis-dap.cfg -f target/${OPENOCD_TARGET} -c "adapter speed 5000" DEPENDS ${PROJECT_NAME})
    add_custom_target(server_rtt openocd -f interface/cmsis-dap.cfg -f target/${OPENOCD_TARGET} -c "adapter speed 5000"
